...
Вбудований рекордер (див. [Можливості](#можливості)) покриває більшість
випадків прямо в застосунку. Якщо хочеш записувати чимось іншим - або звук
надходить іззовні (з телефону, іншого застосунку) - найкращий результат дає
[OBS Studio](https://obsproject.com) (безкоштовний, з відкритим кодом).
Оптимальні налаштування звуку:
