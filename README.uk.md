...
- Вбудований запис: мікрофон, системний звук (те, що чути через
  колонки/навушники), або обидва одразу, змішані в один файл - з живими
  шкалами рівня, паузою/відновленням, відліком 3-2-1, щоб нічого не
  обрізалось на старті, глобальним сполученням клавіш для запису/зупинки, і
  індикатором запису на іконці панелі задач.
...
Користуйся вбудованим рекордером (див. [Можливості](#можливості)) - постав
галочку на **Мікрофон** і/або **Системний звук** і натисни **Record**. Він
сам подбає про формат звуку, тож налаштовувати нічого не треба. Завжди
натискай **Stop**, щоб завершити запис, а не закривай застосунок
посеред запису - інакше файл не фіналізується коректно.
